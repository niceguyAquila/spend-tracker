...
import { creditBookSettlementAttachmentViewSchema } from "@/lib/validation/credit-big-book";
...
export async function GET(request: Request) {
  ...
  const parsed = creditBookSettlementAttachmentViewSchema.safeParse({ id: searchParams.get("id") });
  if (!parsed.success) {
