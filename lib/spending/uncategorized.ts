/**
 * Lazily provision a per-brand "Uncategorized" category. Used by the spending
 * CSV import when a row's category name is blank or does not match an existing name.
 */
